...
public final class RadTest {
    ...
    public final void toDeg() {
        ...
        assertEquals(
            Rad.from(
                PreciseDecimal.from("0.4636476090008061162142562314612144020285370542861202638109330887201978641657417053006002839848878926")
            ).toDeg().toString(),
            PreciseDecimal.from("26.56505117707798935157219372045329467120421429964522102798601631528806582148474061170857381060216472").toString()
        );
        assertEquals(
            Rad.from(
