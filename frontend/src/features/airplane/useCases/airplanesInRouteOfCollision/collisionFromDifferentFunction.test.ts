...
describe('collisionFromDifferentFunction', () => {
    it('should return undefined when there is no collision', () => {
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: 3, y: 5, vector: { direction: 45, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 135, speed: 2 } },
        })).toEqual(undefined);
    });

    it('should return the difference when speed is the same', () => {
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 45, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 135, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 55, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 125, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 65, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 115, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 25, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 155, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
    ...
    it('should return the difference when speed is not the same', () => {
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 55, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 125, speed: 4 } },
        })).toEqual({
            a: '1',
            b: '2',
            collisionPoint: { x: 0, y: 2.8562960135 },
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 65, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 115, speed: 2 } },
        })).toEqual({
            a: '1',
            b: '2',
            collisionPoint: { x: 0, y: 4.289013841 },
        ...
        expect(collisionFromDifferentFunction({
            a: { id: '1', x: -2, y: 0, vector: { direction: 25, speed: 1 } },
            b: { id: '2', x: 2, y: 0, vector: { direction: 155, speed: 2 } },
        })).toEqual({
            a: '1',
            b: '2',
            collisionPoint: { x: 0, y: 0.9326153163 },
