...
describe('airplanesInRouteOfCollisionBusiness', () => {
    it('should return the airplanes in route of collision in the same angle, but opposite directions', () => {
        expect(airplanesInRouteOfCollisionBusiness({
            airplanes: [
                { id: '1', planePoint: { planeType: 'CARTESIAN', a: -2, b: 0 }, vector: { direction: 45, speed: 1 } },
                { id: '2', planePoint: { planeType: 'CARTESIAN', a: 2, b: 0 }, vector: { direction: 135, speed: 1 } },
            ],
            maxTime: 1000,
        })).toEqual([{
            a: '1',
    ...
    it('should return the airplanes in route of collision in the same angle and direction', () => {
        expect(airplanesInRouteOfCollisionBusiness({
            airplanes: [
                { id: '1', planePoint: { planeType: 'CARTESIAN', a: -1, b: 1 }, vector: { direction: 45, speed: 2 } },
                { id: '2', planePoint: { planeType: 'CARTESIAN', a: 1, b: 3 }, vector: { direction: 45, speed: 1 } },
            ],
            maxTime: 1000,
        })).toEqual([{
            a: '1',
    ...
    it('should return the difference when speed is not the same', () => {
        expect(airplanesInRouteOfCollisionBusiness({
            airplanes: [
                { id: '1', planePoint: { planeType: 'CARTESIAN', a: -2, b: 0 }, vector: { direction: 45, speed: 1 } },
                { id: '2', planePoint: { planeType: 'CARTESIAN', a: 2, b: 0 }, vector: { direction: 135, speed: 2 } },
            ],
        ...
        expect(airplanesInRouteOfCollisionBusiness({
            airplanes: [
                { id: '1', planePoint: { planeType: 'CARTESIAN', a: -2, b: 0 }, vector: { direction: 45, speed: 1 } },
                { id: '2', planePoint: { planeType: 'CARTESIAN', a: 2, b: 0 }, vector: { direction: 135, speed: 4 } },
            ],
            maxTime: Number.MAX_SAFE_INTEGER,
        })).toEqual([{
            a: '1',
    ...
    it('should return the difference when speed is not the same', () => {
        ...
        expect(airplanesInRouteOfCollisionBusiness({
            airplanes: [
                { id: '1', planePoint: { planeType: 'CARTESIAN', a: -2, b: 2 }, vector: { direction: 0, speed: 2 } },
                { id: '2', planePoint: { planeType: 'CARTESIAN', a: 2, b: 2 }, vector: { direction: 180, speed: 9 } },
            ],
            maxTime: Number.MAX_SAFE_INTEGER,
        })).toEqual([{
            a: '1',
