...
describe('collisionFromSameFunction', () => {
    it('should return undefined when there is no collision', () => {
        expect(collisionFromSameFunction({
            a: { id: '1', x: -1, y: 1, vector: { direction: 45, speed: 1 } },
            b: { id: '2', x: 1, y: 3, vector: { direction: 45, speed: 1 } },
        })).toEqual(undefined);
    });

    it('should return the collision point when the function is the same', () => {
        expect(collisionFromSameFunction({
            a: { id: '1', x: -1, y: 1, vector: { direction: 45, speed: 2 } },
            b: { id: '2', x: 1, y: 3, vector: { direction: 45, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
        ...
        expect(collisionFromSameFunction({
            a: { id: '1', x: -1, y: 4, vector: { direction: 45, speed: 1 } },
            b: { id: '2', x: 1, y: 6, vector: { direction: 225, speed: 1 } },
        })).toEqual({
            a: '1',
            b: '2',
        ...
        expect(collisionFromSameFunction({
            a: { id: '1', x: -2, y: 2, vector: { direction: 0, speed: 2 } },
            b: { id: '2', x: 2, y: 2, vector: { direction: 180, speed: 9 } },
        })).toEqual({
            a: '1',
            b: '2',
